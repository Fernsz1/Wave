...
import { UserCheck, ShieldCheck, Phone, Calendar, LogOut, Users } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-[0_10px_35px_rgba(0,0,0,0.05)] divide-y divide-slate-100 overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-between text-xs">
          <span className="font-semibold text-slate-500 uppercase tracking-wider flex items-center gap-2">
            <Users className="h-4 w-4 text-slate-400" /> Section / Block
          </span>
          <span className="font-bold text-slate-800">{student.section || student.gradeLevel}</span>
        </div>
