      ...
      >
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-lexend font-extrabold tracking-tight text-white">
              Mabuhay, {student.name}!
            </h1>
            <p className="text-blue-50 text-sm max-w-md leading-relaxed font-medium font-lexend">
