...
interface StudentLessonsProps {
  ...
  navTopicId?: string;
  navViewState?: 'syllabus' | 'reading' | 'quiz' | 'summative' | 'remedial-reading';
...
export default function StudentLessons({
  ...
  const [viewState, setViewState] = useState<'syllabus' | 'reading' | 'quiz' | 'summative' | 'remedial-reading'>('syllabus');
      ...
      {viewState === 'syllabus' && !hasSelectedSubject && (
        <div className="space-y-8 py-4">
          <div className="text-center max-w-2xl mx-auto space-y-3 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <h1 className="font-lexend font-extrabold text-3xl sm:text-4xl text-slate-900 tracking-tight">
