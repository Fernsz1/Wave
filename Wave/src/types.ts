...
export interface TeacherRemediationMaterial {
  ...
  publishDate: string;
  targetSection?: string; // whole-section recipient; remediation is always section-wide
  targetSubject?: string; // carried on the wire as `subject` so student filtering survives
  isPublished: boolean;
}
