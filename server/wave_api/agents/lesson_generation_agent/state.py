...
class AgentState(TypedDict):
    ...
    core_diagnosis: Optional[Dict[str, Any]]              # From DiagnoseMisconception
    
    # --- 3. The Automated AI Evaluation Loop ---
    draft_lesson: Optional[str]
    evaluation_scores: Optional[Dict[str, int]] # Stores the quantitative scores
    is_approved: Optional[bool] # True if all scores >= 4, False if any score <= 3
    revision_remarks: Optional[str] # The 2-3 sentence feedback for the generator
